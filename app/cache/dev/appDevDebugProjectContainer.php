...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_db9d1af901d4602e914177d7498ab7c569c5d8162214f809c78f421fe825aaa7');
    ...
    {
        return $this->services['fos_ck_editor.builder.json_builder'] = new \FOS\CKEditorBundle\Builder\JsonBuilder($this->get('property_accessor', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['fos_ck_editor.command.installer'] = new \FOS\CKEditorBundle\Command\CKEditorInstallerCommand($this->get('fos_ck_editor.installer'));
    }
    ...
    {
        return $this->services['fos_ck_editor.form.type'] = new \FOS\CKEditorBundle\Form\Type\CKEditorType($this->get('fos_ck_editor.config_manager'), $this->get('fos_ck_editor.plugin_manager'), $this->get('fos_ck_editor.styles_set_manager'), $this->get('fos_ck_editor.template_manager'), $this->get('fos_ck_editor.toolbar_manager'));
    }
    ...
    {
        return $this->services['fos_ck_editor.renderer'] = new \FOS\CKEditorBundle\Renderer\CKEditorRenderer($this->get('fos_ck_editor.builder.json_builder'), $this->get('router'), $this->get('assets.packages', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('request_stack'), (($this->has("twig")) ? ($this->get("twig")) : ($this->get("templating"))), (($this->hasParameter("locale")) ? ($this->getParameter("locale")) : (null)));
    }
    ...
    {
        return $this->services['fos_ck_editor.twig_extension'] = new \FOS\CKEditorBundle\Twig\CKEditorExtension($this->get('fos_ck_editor.renderer'));
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('noreply@noreply.com' => 'noreply'), 'resetting' => array('noreply@noreply.com' => 'noreply'))));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => '@FOSCKEditor/Form/ckeditor_widget.html.twig', 1 => 'form_div_layout.html.twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Doctrine\Bundle\DoctrineBundle\Twig\DoctrineExtension());
        $instance->addExtension($this->get('knp_paginator.twig.extension.pagination'));
        $instance->addExtension($this->get('fos_ck_editor.twig_extension'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'console.command.ids' => array(
                ...
                30 => 'fos_ck_editor.command.installer',
